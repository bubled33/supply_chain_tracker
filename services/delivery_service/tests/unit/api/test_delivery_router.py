...
from src.api.deps.getters import get_delivery_service, get_courier_service, get_current_user, get_event_queue
...
def test_mark_delivery_in_transit(mock_mapper, client, mock_delivery_service, mock_event_queue):
    ...
    mock_delivery_service.get.side_effect = [delivery, updated_delivery]
