...
class TestAsyncPostgresCourierRepository:
    ...
    async def test_save_new_courier(self, repository, mock_connection, sample_courier):
        ...
        assert result.name.value == sample_courier.name
        assert result.contact_info.value == sample_courier.contact_info
    ...
    async def test_save_existing_courier(self, repository, mock_connection):
        ...
        assert result.name.value == "Updated Name"
        assert result.contact_info.value == "New Contact"
    ...
    async def test_get_existing_courier(self, repository, mock_connection):
        ...
        assert result.contact_info.value == "+79001234567"
    ...
    def test_row_to_entity(self, repository):
        ...
        assert courier.name.value == "Test Courier"
        assert courier.contact_info.value == "test@example.com"
    ...
    async def test_save_with_special_characters(self, repository, mock_connection):
        ...
        assert result.name.value == "O'Brien"
        assert "test@example.com" in result.contact_info.value
