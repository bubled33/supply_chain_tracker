# warehouse_service/app/api/deps/getters.py
import os
import asyncpg
...
from app.app.services.inventory_record import InventoryService
from app.app.services.warehouse import WarehouseService
from app.infra.db.inventory_repository import AsyncPostgresInventoryRepository
from app.infra.db.warehouse_repository import AsyncPostgresWarehouseRepository
...
db_provider = PostgresPoolProvider(
    dsn=os.getenv(
        "DATABASE_URL",
        "postgresql://bubled:smyrf0202@localhost:5432/supply_chain",
    ),
    min_size=5,
    max_size=20,
)
