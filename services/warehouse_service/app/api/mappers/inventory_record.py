from app.api.dto.inventory_record import InventoryRecordCreateDTO, InventoryRecordUpdateDTO, InventoryRecordDTO
from app.domain.entities.inventory_record import InventoryStatus, InventoryRecord
