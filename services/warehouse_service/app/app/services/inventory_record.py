...
from app.domain.errors.inventory_record import InventoryRecordNotFoundError, InvalidInventoryStatusTransitionError
from app.domain.ports import InventoryRepositoryPort
